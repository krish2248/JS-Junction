  ...
  return (
    <section id="about" className="section">
      <div className="container">
        <div className="bg-red-950 p-7 rounded-2xl md:p-12 reveal-up">
          <p className="text-red-100 mb-4 md:mb-8 md:text-xl md:max-w-[60ch]">
            Experiences
          </p>
          ...
          <p className="text-red-100"> <br/>- Master Dart &quot;object-oriented principles&quot;, enabling me to write clean, efficient, and maintainable code. 
            ...
            {aboutItems.map(({ label, number }, key) => (
              <div key={key}>
                <div className="flex items-center md:mb-2">
                  <span className="text-2xl font-semibold md:text-4xl text-red-100">
                    {number}
                  </span>
